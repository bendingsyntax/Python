...
population = 1000000 #creates population variable and sets to a size
generations = 1000000 #creates generation variable and sets to a size
outputfile = open(r'C:\Users\Daniel E De Jesus\Documents\output.txt', "w+")
