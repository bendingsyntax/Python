...
population = 1000 #creates population variable and sets to a size
generations = 1000 #creates generation variable and sets to a size
...
def mutation(agents): #mutation function
    for agent in agents: #for loop for each agent
        ...
        while k < stringLength:
            if random.uniform(0.0, 1.0) <= .0063: #picks a random number between 0.0 and 1.0 and checks if it is less than .0063
...
if __name__ == '__main__':#main function
    ...
    in_str = "rTaOcTiq5bkpqLs3WjCAyHwJHl9htQih0DQUjcoj" #random generated string.
